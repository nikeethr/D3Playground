...
function plotTSNE(data) {
  ...
  data_aggregate.sort((a, b) => b.total - a.total)
  var label_priority = data_aggregate.map(d => d.label)
  var colorMap = getColorScale(sentiment, label_priority)
  ...
  data.sort((a, b) => label_priority.indexOf(a.label) - label_priority.indexOf(b.label))
...
function plotBar(data) {
  ...
  var colorMap = getColorScale(sentiment, data_aggregate.map(d => d.label))
